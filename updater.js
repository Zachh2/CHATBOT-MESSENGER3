...
const log = require('./logger/logg.js');
let chalk;
try {
...
(async () => {
	const { data: versions } = await axios.get('https://raw.githubusercontent.com/Zachh2/CHATBOT-MESSENGER/main/versions.json');
	...
	for (const filePath in files) {
		...
		let getFile;
		try {
			const response = await axios.get(`https://github.com/Zachh2/CHATBOT-MESSENGER/raw/main/${filePath}`, {
	...
	const { data: packageHTML5 } = await axios.get("https://github.com/Zachh2/CHATBOT-MESSENGER/blob/main/package.json");
